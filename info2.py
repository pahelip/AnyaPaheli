...
#CHANGE BELOW
profile_picture = "Images/Profilee.jpeg"
...
experience_data = {
    "Spider-Man": (["- Helped save the world multiple times",
                                                                          "- Joined the Avengers"],"Images/saving.jpeg"),
    "Photographer at the Daily Bugle":(["- Took pictures of Spiderman that no one else could ",
                                                           "- Skilled in using cameras and understanding angles and lighting"],"Images/photographer.jpeg"),
    "Scientist at Horizon Labs":(["- Analyzed complex problems and came up with creative solutions"],"Images/scientist.jpeg")
...
leadership_data = {
    "Leader of the Spider Army": (["- Led a group of Spider-People from across the multiverse to stop the Inheritors"],"Images/multiverse.jpeg"),
